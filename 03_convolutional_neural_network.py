...
#Goal: Convolutional neural network using TensorFlow library
#Date: 2017/08/14
#----------------------------------------------
...
# Store weight and biases information of layers
weights = {
    # 5 x 5 conv, 1 input, 32 outputs
    'wc1': tf.Variable(tf.random_normal([5, 5, 1, 32])),
    # 5 x 5 conv, 32 input, 64 outputs
    'wc2': tf.Variable(tf.random_normal([5, 5, 32, 64])),
    # Fully connected, 7 x 7 x 64 intputs, 1024 ouputs
